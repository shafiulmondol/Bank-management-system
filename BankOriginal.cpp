...
public:
    ...
    void withdraw(long account_number)
    {
        ...
        else
        {
            ...
            {
                cout << "Enter the ammount from 1--100000\n";
                deposit(account_number);
            }
        }
    }
...
public:
    ...
    {
        long last_account_number = 20000000; // Default if no accounts exist
        long new_account_number;
...
public:
    ...
    inline void problem_1()
    {
        ...
        else if (choice == 5)
        {
            ...
            cout << "|\t-Email: 23303106@iubat.edu                      |" << endl
                 << endl;
            cout << "|_______________________________________________________|" << endl;
    ...
    inline void problem_2()
    {
        ...
        if (choice == 1)
        {
            cout << "Welcome to 'SKS Bank management System!" << endl
                 << endl;
            cout << "Follow these steps to create an account:" << endl
                 << endl;
    ...
    inline void problem_5()
    {
        ...
        if (choice == 1)
        {
            ...
            cout << "   - Provide additional documents if required for certain transactions." << endl
                 << endl;
            ...
            cout << "   - Double-check all details on receipts and confirmation messages." << endl
                 << endl;
            ...
            cout << "   - Use ATMs or on-line banking for transactions outside banking hours." << endl
                 << endl;
            ...
            cout << "   - Keep the counterfoil or acknowledgment slip for future reference." << endl
                 << endl;
            ...
            cout << "   - Use secure methods like demand drafts or bank transfers for high-value transactions." << endl
                 << endl;
            cout << "6. Safety:" << endl;
            ...
            cout << "   - Use strong passwords for on-line banking and change them periodically." << endl
                 << endl;
    ...
    inline void problem_8()
    {
        ...
        if (choice == 1)
        {
            ...
            cout << "  - Your bank will never ask for your PIN or full password through email or phone." << endl
                 << endl;
            ...
            cout << "   - Enable screen lock features on your devices to prevent unauthorized access." << endl
                 << endl;
            ...
            cout << "   - Keep your bank's customer support number saved for quick access." << endl
                 << endl;
            ...
            cout << "  - Customize alerts for large withdrawals or transactions over a specific amount." << endl
                 << endl;
...
void admin()
{
    ...
    {
        while (true)
        { // Loop to stay in the admin section
            chart.for_admin();
            int choice;
            cin >> choice;
            cin.ignore(); // Clear input buffer
